...
"""
    ...
    def execute_ruling(self, in_favour_of: str) -> None:
        ...
        Args:
            in_favour_of: Either "BUYER" or "SELLER" (case-insensitive).
                          The owner may choose to follow the AI ruling or
                          override it with their own judgement.
        ...
        if ruling not in ("BUYER", "SELLER"):
            raise Exception("in_favour_of must be 'BUYER' or 'SELLER'")
