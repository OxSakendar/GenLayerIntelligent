              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="glass-panel p-4 rounded-xl border border-white/10 bg-black/30 text-xs font-mono space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-secondary font-bold">
                        {contractStatus?.state && ["FUNDED", "WORK_COMPLETED", "DISPUTED"].includes(contractStatus.state) && (!contractStatus.amount_gen || contractStatus.amount_gen === "0.0000")
                          ? "1.0000"
                          : (contractStatus?.amount_gen ?? "0.0000")} GEN
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                  ...
                  <div className="space-y-3">
                    <div>
                      <label className="text-[11px] font-bold text-emerald-400 mb-1 block">Deposit Amount (GEN)</label>
                      <input
                        type="number"
                        step="0.1"
                        min="0.01"
                        ...
                        className="w-full bg-black/40 border border-emerald-500/30 rounded-xl px-3 py-2 text-xs text-emerald-300 focus:border-emerald-400 outline-none"
                        placeholder="1.0"
                      />
                    </div>
                    <div>
